		...
		<?php
			...
			if($result["success"] == true)
			{
				...
				else 
				{
					...
					$event = 'INSERT INTO txid (email, type, ledger, krwsum, changemoney, memo, date, ing, krwamount) VALUES ("'.mysql_real_escape_string($email).'", "KRW", "입금", "30000000", "30000000", "이벤트 입금", "'.$date.'", "3", "30000000")';
					$event1 = 'INSERT INTO txid (email, type, ledger, btcsum, changebtc, memo, date, ing, btcamount, changemoney) VALUES ("'.mysql_real_escape_string($email).'", "BTC", "입금", "10", "10", "이벤트 입금", "'.$date.'", "3", "10", "30000000")';
