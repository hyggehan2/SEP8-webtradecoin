							...
							<form action="./join_do.php" method="POST" accept-charset="UTF-8" role="form" class="form-signin">
								<fieldset>
									<label class="panel-login">
										<div class="login_result">Maplestep.site 회원가입</div>
									</label>
									<input type="text" class="form-control" id="email" name="email" maxlength="30" placeholder="사용할 아이디" required autofocus>
									<input type="text" class="form-control" id="name" name="name" maxlength="30" placeholder="메이플 닉네임" required autofocus>
									...
									비밀번호는 암호화되어 저장되나 타사이트와 다른비밀번호를 사용하여주세요.
								</fieldset>
							</form>	
						</div>
